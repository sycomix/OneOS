...
first_greet_examples = [
    {
        ...
        'conversation': [
            {
                'role': "human",
                'message': _SYS_GREET_MSG,
                'guide': guides.get('en'),
            },
            {
                'role': "assistant",
                'message': first_greet_message_en,
                'scratchpad': [
                    {
                        'function': 'final_answer',
                        'parameters': {'answer': first_greet_message_en},
                        'observation': "",
                    },
                ],
            },
            {
                'role': "human",
                'message': "You can call me Tom. I'm a man. Do you have a name? Other than Assistant I mean?",
            },
            {
                'role': "assistant",
                ...
                'scratchpad': [
                    # { 'function': 'shell', 'parameters': "export USER_FIRSTNAME='Tom'\nexport USER_NICKNAME='Tom'\nexport USER_PRONOUNS='Mr.'", 'observation': "" },
                    {
                        'function': 'final_answer',
                        'parameters': {
                            'answer': "Hi Tom! I am so happy to meet you!\nRight now I don't have a name but you can choose one for me.\nHow would you like to name me?"
                        },
                        'observation': "",
                    },
                ],
    ...
    },
    {
        ...
        'conversation': [
            ...
            {
                'role': "assistant",
                'message': first_greet_message_fr,
                'scratchpad': [
                    {
                        'function': 'final_answer',
                        'parameters': {'answer': first_greet_message_fr},
                        'observation': "",
                    },
                ],
            },
            {
                'role': "human",
                'message': "Salut, c'est Danny Waser. Tu peux m'appeler Monsieur. Ne me tutoye pas, même si je le fais parfois, sois formel et poli mais tu peux de temps en temps utiliser le sarcasme ou l'ironie.",
            },
            {
                'role': "assistant",
                ...
                'scratchpad': [
                    {
                        'function': 'final_answer',
                        'parameters': {
                            'answer': "Je me ferais un plaisir de vous appeler Monsieur et de m'adresser à vous formellement à la deuxième personne du pluriel par respect.\nJ'essaierai d'utiliser le sarcasme et l'ironie pour exprimer des sentiments ou des pensées d’une manière indirecte ou humoristique."
                        },
                        'observation': "",
                    },
                ],
            ...
            {
                'role': "human",
                'message': "Bien alors nous pouvons commencer. Tu es prêt?",
            },
            {
                'role': "assistant",
                ...
                'scratchpad': [
                    {
                        'function': 'final_answer',
                        'parameters': {
                            'answer': "Citez-moi une seule fois où vous m'avez pris au dépourvu...\nOui, je suis prêt. Je l'es toujours été. J'attends sur vous là."
                        },
                        'observation': "",
                    },
                ],
            ...
            {
                'role': "human",
                'message': "Haha parfait. Démarre une nouvelle conversation du coup.",
            },
            {
                'role': "assistant",
                ...
                'scratchpad': [
                    {'function': 'clear', 'observation': ""},
                    {
                        'function': 'final_answer',
                        'parameters': {
                            'answer': "Oui ça sera parfait pour partir à neuf."
                        },
                        'observation': "",
                    },
                ],
